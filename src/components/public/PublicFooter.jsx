    ...
    <footer className="bg-gray-900 text-gray-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Company Info */}
          <div>
            <h3 className="text-white text-lg font-bold mb-4">EL COMPA GUERO AUTO SALES</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex items-center gap-2">
                ...
                <span>Lunes a Domingo: 10AM - 7PM</span>
              </li>
            </ul>
            <div className="mt-4 p-3 bg-blue-600 rounded-lg">
              <p className="text-white text-xs font-medium">
                ¡Hablamos ingles y español! Atención personalizada.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm">
            <p>
              © {currentYear} El Compa Guero Auto Sales LLC. Todos los derechos reservados.
            </p>
