        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative z-10 rounded-3xl overflow-hidden aspect-[5/4] lg:aspect-square"
              ...
              {settings.heroImage && (
                <img 
                  ...
                  alt={settings.heroImageAlt || (language === 'es' ? 'Auto destacado' : 'Featured car')}
          ...
          <div className="space-y-8 order-2 lg:order-1 text-center lg:text-left">
            <div>
              <span className="inline-block px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full text-sm font-medium mb-6">
                {language === 'es' 
                  ...
                  : 'Pre-owned cars in Salem, Oregon.'}
              </span>
              <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
                {t('hero.title')}
                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-orange-400">
                  {language === 'es' ? 'sin intereses' : 'interest-free'}
                </span>
              </h1>
              <p className="text-base md:text-xl lg:text-xl text-blue-100 leading-relaxed">
                {t('hero.subtitle')}
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              >
                {language === 'es' ? 'Aplicar para financiamiento' : 'Apply for Financing'}
              </Link>
            </div>
            ...
            <div className="flex gap-6 justify-center lg:justify-start">
              ...
              <div className="text-center">
                ...
                <p className="text-xs md:text-sm text-blue-200">
                  {language === 'es' ? 'Rating en Google' : 'Google Rating'}
                </p>
              </div>
            </div>
          </div>
